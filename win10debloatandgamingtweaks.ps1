...
#
#     > powershell -nop -c "iex(New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/thornethorne/Windows10GamingFocus/master/win10debloatandgamingtweaks.ps1')"
#
